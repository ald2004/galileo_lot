...
if __name__ == '__main__':
    ...
    for i in range(90):
        with open(f'{rootdir}test_{i}_json.json', 'r') as fp:
    ...
    plt.savefig(f'{rootdir}get_data_{truetime}.png')
    # plt.show()
    image = Image.open(f'{rootdir}get_data_{truetime}.png')
    # image = image.resize((128, 64))
    gay = image.convert("1")
    gay.save(f'{rootdir}get_data_{truetime}.png')
